...
| [**MultiMaid**](https://github.com/GareBear99/MultiMaid) | Focused multiband dynamics for the Maid suite, intentionally non-overlapping with FreeEQ8 / GlueMaid / MixMaid / BassMaid / SpaceMaid / ChainMaid / MeterMaid · [Official site / repo](https://github.com/GareBear99/MultiMaid) |
| [**MeterMaid**](https://github.com/GareBear99/MeterMaid) | ITU-R BS.1770-4 / EBU R128 mastering + metering suite with octagonal target radar, LRA, PSR/PLR, spectrogram, chromagram, goniometer · [Official site / repo](https://github.com/GareBear99/MeterMaid) |
