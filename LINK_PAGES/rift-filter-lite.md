...
![Rift Filter Lite demo card](assets/rift-filter-lite.png)
...
This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Rift Filter Lite** is, what kind of reader it suits, and where to go next.
