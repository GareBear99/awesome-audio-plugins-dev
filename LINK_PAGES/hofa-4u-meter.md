...
![HOFA 4U Meter demo card](assets/hofa-4u-meter.png)
...
Level, correlation, and goniometer meters.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **HOFA 4U Meter** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://hofa-plugins.de/en/plugins/4u/](https://hofa-plugins.de/en/plugins/4u/)
