...
![DreamEater demo card](assets/dreameater.png)
...
Audio mangling effect.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **DreamEater** is, what kind of reader it suits, and where to go next.
