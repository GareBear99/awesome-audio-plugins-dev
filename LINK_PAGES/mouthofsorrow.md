...
![MouthOfSorrow demo card](assets/mouthofsorrow.png)
...
This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **MouthOfSorrow** is, what kind of reader it suits, and where to go next.
