...
![Odin2 demo card](assets/odin2.png)
...
Hybrid synth with analog-modeled filters.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Odin2** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://thewavewarden.com/odin2/](https://thewavewarden.com/odin2/)
