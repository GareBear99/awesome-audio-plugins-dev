...
![NIH-plug demo card](assets/nih-plug.png)
...
Rust-based plugin framework.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **NIH-plug** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://github.com/robbert-vdh/nih-plug](https://github.com/robbert-vdh/nih-plug)
