...
![TDR SlickEQ demo card](assets/tdr-slickeq.png)
...
Musical 3-band mixing EQ with saturation and output-stage models.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **TDR SlickEQ** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://www.tokyodawn.net/tdr-slickeq/](https://www.tokyodawn.net/tdr-slickeq/)
