...
![Wolf Shaper demo card](assets/wolf-shaper.png)
...
Open-source waveshaper with drawable curve.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Wolf Shaper** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://github.com/wolf-plugins/wolf-shaper](https://github.com/wolf-plugins/wolf-shaper)
