...
![RoughRider3 demo card](assets/roughrider3.png)
...
Character compressor with strong coloration.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **RoughRider3** is, what kind of reader it suits, and where to go next.
