...
![MusicDSP Archive demo card](assets/musicdsp-archive.png)
...
DSP algorithm snippets and references.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **MusicDSP Archive** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://www.musicdsp.org](https://www.musicdsp.org)
