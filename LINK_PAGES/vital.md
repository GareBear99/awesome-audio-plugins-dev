...
![Vital demo card](assets/vital.png)
...
Advanced wavetable synthesizer with spectral warping and extensive modulation.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Vital** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://vital.audio](https://vital.audio)
