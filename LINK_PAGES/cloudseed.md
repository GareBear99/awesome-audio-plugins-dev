...
![CloudSeed demo card](assets/cloudseed.png)
...
Algorithmic reverb for very large spaces.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **CloudSeed** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://github.com/ValdemarOrn/CloudSeed](https://github.com/ValdemarOrn/CloudSeed)
