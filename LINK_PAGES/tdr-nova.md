...
![TDR Nova demo card](assets/tdr-nova.png)
...
Dynamic parametric EQ with sidechain.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **TDR Nova** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://www.tokyodawn.net/tdr-nova/](https://www.tokyodawn.net/tdr-nova/)
