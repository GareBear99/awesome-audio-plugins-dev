...
![ReaEQ demo card](assets/reaeq.png)
...
Unlimited-band parametric EQ from Cockos.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **ReaEQ** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://www.reaper.fm/reaplugs/](https://www.reaper.fm/reaplugs/)
