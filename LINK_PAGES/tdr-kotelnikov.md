...
![TDR Kotelnikov demo card](assets/tdr-kotelnikov.png)
...
Transparent wideband dynamics processor.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **TDR Kotelnikov** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://www.tokyodawn.net/tdr-kotelnikov/](https://www.tokyodawn.net/tdr-kotelnikov/)
