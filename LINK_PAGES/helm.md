...
![Helm demo card](assets/helm.png)
...
Cross-platform polyphonic synth.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Helm** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://tytel.org/helm/](https://tytel.org/helm/)
