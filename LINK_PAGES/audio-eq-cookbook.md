...
![Audio EQ Cookbook demo card](assets/audio-eq-cookbook.png)
...
Classic biquad filter formulas and reference material.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Audio EQ Cookbook** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://www.w3.org/2011/audio/audio-eq-cookbook.html](https://www.w3.org/2011/audio/audio-eq-cookbook.html)
