...
![Surge XT demo card](assets/surge-xt.png)
...
Open-source hybrid synth with deep modulation and a large feature set.

## Why it belongs in this repository

This page gives readers a cleaner handoff from the main list to deeper evaluation. Instead of forcing a blind click, it explains what **Surge XT** is, what kind of reader it suits, and where to go next.
...
- **Website / repo:** [https://surge-synthesizer.github.io](https://surge-synthesizer.github.io)
